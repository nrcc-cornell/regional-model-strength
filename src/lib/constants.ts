...
export const rowNames = {
  "Temperature": ["Mean Temperature", "Daily Temp Runs"],
  "Precipitation": ["Total Precipitation", "Maximum Annual Max Precipitation"]
} as const;
...
export const mapsInfo = [{
  ...
  src: 'loca_rx1dayMean_downscale_bias_map.png'
},{
  src: 'loca_rx1dayMax_downscale_bias_map.png'
}];