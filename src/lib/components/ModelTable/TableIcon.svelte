<script lang="ts">
  ...
  let { value, handleCellClick }: TableIconProps = $props();

  // svelte-ignore non_reactive_update
  let icon = "neutral", color = "#d2e847", rotation = "rotate-0";
...
<div class='w-full h-full flex justify-center items-center'>
  <button onclick={handleCellClick} class='h-6 w-6 {rotation} hover:cursor-pointer'>
